...
import { ContactEdit } from '../contact/ContactAdd'
import { ContactBasicInfo } from '../utils/unit/DetailsBasicInfo';
...
export default class ContactDetails extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            // 패널 모드
            contactEditPanel             : false,          // 연락처 수정 호출
            contactMorePanel             : false,          // 연락처 더보기 호출
    ...
    // 연락처 수정 호출
    handleClickContactEdit = () => { this.setState({ contactEditPanel : true });}
    // 연락처 더보기 호출
    handleClickContactMore = () => { this.setState({ contactMorePanel : true });}
    // 사용중인 품목 호출
            ...
            <Fragment>
                <div className="flex-1 v-box">
                    ...
                    <HeaderComp
                        ...
                        handleClickContactEdit={this.handleClickContactEdit}
                        handleClickContactMore={this.handleClickContactMore} 
                    />
                    {/* 상세 컨텐츠 */}
                    <div className={`viewBody flex-1 v-box scroll_y_on ${this.state.tabStateOpen02 ? 'bgType1':'bgType2'}`}>
                        ...
                        <div className="detailsHeader h-box posi_stk" style={{top:'0px'}}>
                            <div className="dh-con flex-1 v-box">
                                <div className="h-box">
                                    <div className="title flex-1 h-box">김초롱<div className="line" />아임사이언스</div>
                                    <div className="contactStateBox">
                                        <div className="type2">거래중</div>
                                    </div>
                                </div>
                                <div className="h-box">
                                    <div className="txt-c1">010-6490-0569</div>
                                    <div className="line"/>
                ...
                <PanelWrap 
                    Type='bs' 
                    Open={this.state.contactMorePanel} 
                    Close={this.handleClickPanelClose}
                >
                    <MenuSheetComp type={'contactMore'} />
                </PanelWrap>

                {/* 연락처-수정 */}
                <PanelWrap 
                    Type='sub' 
                    Open={this.state.contactEditPanel} 
                >
                    <ContactEdit 
