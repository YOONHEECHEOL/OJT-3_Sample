                ...
                <div className="flex-1 v-box">
                    ...
                    <div className={`panelHeader h-box`}>
                        <div className="leftFnDiv">
                            <span className="closeBtn" onClick={()=>{this.props.handleClickPanelClose('orderRequestPanel');}} />
                        </div>
                        <div className="titleDiv flex-1 h-box">
                            <span className="title">주문요청</span>
                        </div>
                        ...
                        <div className="basicContents">
                            ...
                            <div className="editUnit h-box">
                                <dl className="v-box flex-1">
                                    ...
                                    <dd className="flex-1 h-box">
                                        <input type="text" className="inputField flex-1" value={this.state.textInput01} placeholder='고객사명을 입력해주세요.' onChange={(e) => this.setState({ textInput01: e.target.value })} readOnly/>
                                    </dd>
                                </dl>
                            </div>
                            <div className="editUnit h-box">
                                <dl className="v-box flex-1">
                                    <dt>고객담당자</dt>
                                    <dd className="flex-1 h-box">
                                        <input type="text" className="inputField flex-1" value={this.state.textInput02} placeholder='고객담당자를 입력해주세요.' onChange={(e) => this.setState({ textInput02: e.target.value })} readOnly/>
                                    </dd>
                                </dl>
                            </div>
                            <div className="editUnit h-box">
                                <dl className="v-box flex-1">
                                    <dt>영업담당자</dt>
                                    <dd className="flex-1 h-box">
                                        <input type="text" className="inputField flex-1" value={this.state.textInput03} placeholder='영업담당자를 입력해주세요.' onChange={(e) => this.setState({ textInput03: e.target.value })} readOnly/>
                                    </dd>
                                </dl>
                            </div>
                            <div className="editUnit h-box">
                                <dl className="v-box flex-1">
                                    <dt>주문담당자<span className="imp">*</span></dt>
                                    <dd className="flex-1 h-box">
                                        <input type="text" className="inputField flex-1" value={this.state.textInput04} placeholder='주문담당자를 입력해주세요.' onChange={(e) => this.setState({ textInput04: e.target.value })}/>
                                    </dd>
                                </dl>
                            ...
                            <div className="editUnit h-box">
                                <dl className="v-box flex-1">
                                    <dt>첨부파일</dt>
                                    <dd className="flex-1 h-box">
                                        <input type="text" className="inputField flex-1" value={this.state.textInput06} placeholder='첨부파일을 등록해주세요.' onChange={(e) => this.setState({ textInput06: e.target.value })} readOnly/>
                                    </dd>
                                </dl>
                                <div className="fnBtn h-box">
