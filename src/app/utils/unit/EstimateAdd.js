...
// 견적 등록
export default class EstimateAdd extends Component {
    constructor(props) {
        super(props);
        ...
        this.state = {
            ...
            textInput09: '고객본사',
            textInput10: '현금일시납',
            textInput11: 'Amaranth10 업셀 프로모션',
            textInput12: '김영묵 대리',
                ...
                <div className="flex-1 v-box">
                    ...
                    <div className={`panelHeader h-box`}>
                        <div className="leftFnDiv">
                            <span className="closeBtn" onClick={()=>{this.props.handleClickPanelClose('estimateAddPanel');}} />
                        </div>
                        <div className="titleDiv flex-1 h-box">
                            <span className="title">견적등록</span>
                        </div>
                        ...
                        <div className="basicContents">
                            ...
                            <div className="editUnit h-box">
                                <dl className="v-box flex-1">
                                    <dt>견적번호</dt>
                                    <dd className="flex-1 h-box">
                                        <input type="text" className="inputField flex-1" value={this.state.textInput03} placeholder='견적번호' onChange={(e) => this.setState({ textInput03: e.target.value })} readOnly/>
                                    </dd>
                                </dl>
                            </div>
                            <div className="editUnit h-box">
                                <dl className="v-box flex-1">
                                    <dt>견적일자<span className="imp">*</span></dt>
                                    <dd className="flex-1 h-box">
                                        <input type="text" className="inputField flex-1" value={this.state.textInput04} placeholder='견적일자를 선택해주세요.' onChange={(e) => this.setState({ textInput04: e.target.value })} readOnly/>
                                    </dd>
                                </dl>
                                <div className="fnBtn h-box">
                            ...
                            <div className="editUnit h-box">
                                <dl className="v-box flex-1">
                                    <dt>유효일자<span className="imp">*</span></dt>
                                    <dd className="flex-1 h-box">
                                        <input type="text" className="inputField flex-1" value={this.state.textInput05} placeholder='유효일자를 선택해주세요.' onChange={(e) => this.setState({ textInput05: e.target.value })} readOnly/>
                                    </dd>
                                </dl>
                                <div className="fnBtn h-box">
                                    <span className="calBtn flex-1"/>
                            ...
                            <div className="editUnit h-box">
                                <dl className="v-box flex-1">
                                    <dt>견적차수</dt>
                                    <dd className="flex-1 h-box">
                                        <input type="text" className="inputField flex-1" value={this.state.textInput06} placeholder='견적차수' onChange={(e) => this.setState({ textInput06: e.target.value })} readOnly/>
                                    </dd>
                                </dl>
                            </div>
                            <div className="editUnit h-box">
                                <dl className="v-box flex-1">
                                    ...
                                    <dd className="flex-1 h-box">
                                        <input type="text" className="inputField flex-1" value={this.state.textInput07} placeholder='과세구분을 선택해주세요.' onChange={(e) => this.setState({ textInput07: e.target.value })} readOnly/>
                                    </dd>
                                </dl>
                                <div className="fnBtn h-box">
                            ...
                            <div className="editUnit h-box">
                                <dl className="v-box flex-1">
                                    ...
                                    <dd className="flex-1 h-box">
                                        <input type="text" className="inputField flex-1" value={this.state.textInput08} placeholder='단가구분을 선택해주세요.' onChange={(e) => this.setState({ textInput08: e.target.value })} readOnly/>
                                    </dd>
                                </dl>
                                <div className="fnBtn h-box">
                            ...
                            <div className="editUnit h-box">
                                <dl className="v-box flex-1">
                                    <dt>납품장소</dt>
                                    <dd className="flex-1 h-box">
                                        <input type="text" className="inputField flex-1" value={this.state.textInput09} placeholder='납품장소' onChange={(e) => this.setState({ textInput09: e.target.value })} readOnly/>
                                    </dd>
                                </dl>
                            </div>
                            <div className="editUnit h-box">
                                <dl className="v-box flex-1">
                                    <dt>결제조건</dt>
                                    <dd className="flex-1 h-box">
                                        <input type="text" className="inputField flex-1" value={this.state.textInput10} placeholder='결제조건' onChange={(e) => this.setState({ textInput10: e.target.value })} readOnly/>
                                    </dd>
                                </dl>
                            </div>
                            <div className="editUnit h-box">
                                <dl className="v-box flex-1">
                                    <dt>캠페인선택</dt>
                                    <dd className="flex-1 h-box">
                                        <input type="text" className="inputField flex-1" value={this.state.textInput11} placeholder='캠페인선택' onChange={(e) => this.setState({ textInput11: e.target.value })} readOnly/>
                                    </dd>
                                </dl>
                            </div>
                            <div className="editUnit h-box">
                                <dl className="v-box flex-1">
                                    <dt>영업담당자</dt>
                                    <dd className="flex-1 h-box">
                                        <input type="text" className="inputField flex-1" value={this.state.textInput12} placeholder='영업담당자' onChange={(e) => this.setState({ textInput12: e.target.value })} readOnly/>
                                    </dd>
                                </dl>
                            </div>
                    ...
                    <div className="subPageBtn h-box">
                        <div className="pageBtn" onClick={this.handleClickPreviousQuoteListComp}>이전차수 불러오기</div>
